  ...
  <div class="fixed inset-0 bg-black/80 flex items-center justify-center z-50 animate-fade-in p-4 sm:p-6">
    <div class="bg-zinc-900 border border-zinc-700 rounded-xl w-full max-w-lg shadow-2xl overflow-hidden max-h-[95vh] flex flex-col">
      ...
      <div class="p-5 sm:p-6 overflow-y-auto flex-1 custom-scrollbar">
        <form @submit.prevent="salvarEdicao" class="flex flex-col gap-5">
          ...
          <div class="grid grid-cols-2 gap-4">
            <div>
              ...
              <p class="text-xs text-zinc-600 mt-1">Código não pode ser alterado.</p>
            </div>
            <div>
          ...
          <div class="grid grid-cols-2 gap-4">
            <div>
              ...
              <select v-model="moldeAtualizado.empresaId" class="w-full bg-zinc-950 text-white border border-zinc-800 rounded-lg px-4 py-2.5 focus:outline-none focus:border-orange-500 transition-colors appearance-none cursor-pointer">
          ...
          <div class="border-t border-zinc-800 pt-5 mt-3">
          ...
          <div class="flex justify-end gap-3 mt-4 pt-4 border-t border-zinc-800 shrink-0 bg-zinc-900">
